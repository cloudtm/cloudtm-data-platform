 ...
 * @since 5.2
 */
@Test(groups = "functional", testName = "tx.totalorder.DistTotalOrderStateTransferFunctionalTest")
public class DistTotalOrderStateTransferFunctionalTest extends StateTransferFunctionalTest {
