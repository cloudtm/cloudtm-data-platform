...
/**
 * Cluster Snapshot that gives a view of the cluster with the members. 
 * This structure ensures the same index for the same address in every member of the cluster and
 * it has search complexity of n*log(n) (as in Arrays.binarySearch())
 *
...
public class ClusterSnapshot {
   ...
   /**
    * returns the address in the position defined by {@code index} or null if the index is negative or higher than
    * the size of this collection
    *
    * @param index   the index
    * @return        the address in the position defined by {@code index} or null if the index is negative or higher 
    *                than the size of this collection
    */
   ...
   /**
    * returns true if this collection contains the address, false otherwise.
    * More formally, returns true if indexOf(address) != -1
    *
    * @param address the address
